          ...
          F: RenderFrame
{
    ...
    pub fn run_forever<R, G>(
        &mut self,
        mut gen_events: impl FnMut(&mut FnMut(Option<PopupID>, WindowEvent, Option<ModifierKeys>) -> EventLoopResult<G>) -> Option<G>,
