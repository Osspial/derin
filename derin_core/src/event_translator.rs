            ...
            |event_dispatcher, OffsetWidgetScanPath{mut widget, path, widget_id, index}, event| {
                ...
                match event {
                    ...
                    DispatchableEvent::MouseMove{old_pos, new_pos, exiting_from_child} => {
                        ...
                        let mut send_exiting_from_child = |widget: &mut OffsetWidget<'_, D>, in_widget| {
...
mod tests {
    ...
    use crate::{
        ...
        cgmath::Point2,
        test_helpers::{TestEvent, TestDisplayEngine},
    ...
    macro_rules! create_translator {
        ($translator:pat, $tree:expr, $root_id:expr) => {
            ...
            let mut traverser_base: WidgetTraverserBase<TestDisplayEngine> = WidgetTraverserBase::new($root_id);
