...
impl ImageSlicer {
    pub fn new(image_id: ImageId, image_dims: DimsBox<D2, i32>, rect: BoundBox<D2, i32>, margins: Margins<i32>) -> ImageSlicer {
        ImageSlicer {
            image_id,
            image_dims,
            rect,
    ...
    fn next(&mut self) -> Option<Rect> {
        ...
        let ret = match self.index {
            ...
            0 => Some(Rect {
                ...
                fill: RectFill::Image {
                    image_id,
                    rect: BoundBox::new(sample_00, sample_11),
                }
            }),
            // □■□
            // □□□
            ...
            1 => Some(Rect {
                ...
                fill: RectFill::Image {
                    image_id,
                    rect: BoundBox::new(sample_01 + zr, sample_12 + zl),
                }
            }),
            // □□■
            // □□□
            ...
            2 => Some(Rect {
                ...
                fill: RectFill::Image {
                    image_id,
                    rect: BoundBox::new(sample_02, sample_13),
                }
            }),
            // □□□
            // □□■
            ...
            3 => Some(Rect {
                ...
                fill: RectFill::Image {
                    image_id,
                    rect: BoundBox::new(sample_12 + dz, sample_23 + uz),
                }
            }),
            // □□□
            // □□□
            ...
            4 => Some(Rect {
                ...
                fill: RectFill::Image {
                    image_id,
                    rect: BoundBox::new(sample_22, sample_33),
                }
            }),
            // □□□
            // □□□
            ...
            5 => Some(Rect {
                ...
                fill: RectFill::Image {
                    image_id,
                    rect: BoundBox::new(sample_21 + zr, sample_32 + zl),
                },
            }),
            // □□□
            // □□□
            ...
            6 => Some(Rect {
                ...
                fill: RectFill::Image {
                    image_id,
                    rect: BoundBox::new(sample_20, sample_31),
                },
            }),
            // □□□
            // ■□□
            ...
            7 => Some(Rect {
                ...
                fill: RectFill::Image {
                    image_id,
                    rect: BoundBox::new(sample_10 + dz, sample_21 + uz),
                },
            }),
            // □□□
            // □■□
            ...
            8 => Some(Rect {
                ...
                fill: RectFill::Image {
                    image_id,
                    rect: BoundBox::new(sample_11 + dr, sample_22 + ul),
                }
            }),
            9 => None,
            _ => unreachable!()
...
mod tests {
    ...
    /// +0
    /// ```
    fn rects_from_string(s: &str, first_alphanumeric_is_origin: bool) -> HashMap<char, BoundBox<D2, i32>> {
